...
Scheme = {
    ...
    MainColor = Color3.fromRGB(35, 10, 15), -- vermelho vinho leve
    AccentColor = Color3.fromRGB(170, 40, 60), -- vermelho bonito
...
function Library:MakeOutline(Frame: GuiObject, Corner: number?, ZIndex: number?)
    ...
    if not (name:find("group") or name:find("groupbox") or name:find("label")) then
        local Glow = Instance.new("UIStroke")
        Glow.Color = Color3.fromRGB(170, 40, 60)
        Glow.Thickness = 2
        ...
        SoftGlow.Color = Color3.fromRGB(170, 40, 60)
        SoftGlow.Thickness = 5
        SoftGlow.Transparency = 0.96
...
function Library:AddDraggableLabel(Text: string)
    ...
    Library:MakeOutline(Label, Library.CornerRadius, Label.ZIndex)
...
if Library.IsMobile then
    ...
    Toggleimg.Size = UDim2.fromOffset(42, 42)
    Toggleimg.Position = UDim2.fromOffset(8, 8)
    Toggleimg.BackgroundColor3 = Color3.fromHex("#0f0f0f")
    Toggleimg.BorderSizePixel = 0
    Toggleimg.ZIndex = 100
    Toggleimg.Parent = ScreenGui

    local icon = Lucide:GetIcon("menu", 24)
    icon.AnchorPoint = Vector2.new(0.5, 0.5)
    icon.Position = UDim2.fromScale(0.5, 0.5)
    icon.Parent = Toggleimg

    local stroke = Instance.new("UIStroke")
    stroke.Color = Color3.fromRGB(40,40,40)
    stroke.Thickness = 1.5
    stroke.Parent = Toggleimg

    local corner = Instance.new("UICorner")
    corner.CornerRadius = UDim.new(0, 8)
    corner.Parent = Toggleimg

    Toggleimg.MouseEnter:Connect(function()
        Toggleimg.BackgroundColor3 = Color3.fromHex("#202021")
    end)

    Toggleimg.MouseLeave:Connect(function()
        Toggleimg.BackgroundColor3 = Color3.fromHex("#0f0f0f")
    end)
    ...
    if WindowInfo.MobileButtonsSide == "Right" then
        Toggleimg.Position = UDim2.new(1, -8, 0, 8)
