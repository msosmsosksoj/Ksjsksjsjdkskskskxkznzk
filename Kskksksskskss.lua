...
function Library:AddOutline(Frame: GuiObject)
    ...
    -- Gradiente pra deixar mais bonito
    ...
    return GlowMain, GlowSoft
end

--// Deprecated \\--
function Library:MakeOutline(Frame: GuiObject, Corner: number?, ZIndex: number?)
	warn("Obsidian:MakeOutline is deprecated, agora usa glow.")
