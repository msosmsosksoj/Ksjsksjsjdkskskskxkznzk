...
do
    local oldMakeOutline = Library.MakeOutline

    function Library:MakeOutline(Frame: GuiObject, Corner: number?, ZIndex: number?)
        local Holder, Outline = oldMakeOutline(self, Frame, Corner, ZIndex)
        ...
        SoftGlow.Color = GlowColor
        SoftGlow.Thickness = 4
        SoftGlow.Transparency = 0.95
